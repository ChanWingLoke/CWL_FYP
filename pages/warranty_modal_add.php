<?php // pages/warranty_modal_add.php ?>
<div class="modal fade" id="modalWarrantyAdd" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <form action="app/action/warranty_save.php" method="post" autocomplete="off">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Asset</label>
            <select name="asset_id" id="a_asset" class="form-control select2" required>
          ...
          <div class="form-group">
            <label>Vendor</label>
            <input type="text" name="vendor_name" id="a_vendor" class="form-control" placeholder="e.g. Dell, Lenovo, etc.">
          </div>
          <div class="form-group">
            <label>Start / End</label>
            <div class="d-flex">
              <input type="text"
                    name="start_date" id="a_start"
